...
void main()
{
	...
	gl_FragColor = vec4(col, 0.);
		...
		gl.uniform3f(this.programInfo.uniformLocations.resolution, gl.canvas.width, gl.canvas.height, 0.0);
		gl.uniform1f(this.programInfo.uniformLocations.time, 1.0);
	...
	show( timeStamp ){
		...
		gl.uniform1f(this.programInfo.uniformLocations.time, timeStamp/1000.0 );
